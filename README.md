...
6.2. four-digit_numbers.js - В программе задана переменная values, которая хранит в себе массив. Элементы массива являются числами. 
...
6.3 four-digit_numbers_index.js - Необходимо доработать программу из задания 2.7 - В программе задана переменная values,
...
6.4. meaning_more_than_one_word.js - В программе задана переменная users, которая хранит в себе массив. 
